...
import { useGetMeQuery } from '../api/authApi'; // ✅ Import your backend API
import {
  Settings,
  LogOut,
  LayoutDashboard,
...
const Sidebar = () => {
  ...
  const { data: backendData } = useGetMeQuery(); // ✅ Your backend data
  
  console.log(clerkUser, "cccc");
  console.log(backendData, "sdasdads");
  

  const { sidebarOpen, setSidebarOpen, sidebarCollapsed, activeTab, setActiveTab } = useLayout();
  
  // ✅ Combine Clerk + Backend data
  const userData = {
    name: clerkUser?.fullName || clerkUser?.firstName || 'User',
    email: clerkUser?.primaryEmailAddress?.emailAddress,
    avatar: clerkUser?.imageUrl,
    // careerGoal: backendData?.user?.careerGoal || 'Not set yet'
  };
