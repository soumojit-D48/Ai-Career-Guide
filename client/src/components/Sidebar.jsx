...
//               className={`flex items-center w-full px-4 py-3 text-destructive rounded-lg hover:bg-destructive/10 transition-all duration-200
//                 ${sidebarCollapsed ? 'lg:justify-center' : ''}`}
...
const Sidebar = () => {
  ...
  { id: 'career-quiz', icon: ClipboardList, label: 'Career Quiz' },
  { id: 'college-finder', icon: GraduationCap, label: 'College Finder' },
  { id: 'ai-roadmap', icon: Compass, label: 'AI Roadmap' },
  { id: 'job-hunting', icon: Briefcase, label: 'Job Hunting' },
  { id: 'resume-analyzer', icon: FileText, label: 'Resume Analyzer' },
  { id: 'courses', icon: BookOpen, label: 'Learning Resources' },
  { id: 'ai-mentor', icon: Bot, label: '1v1 AI Mentor' },
  ];
